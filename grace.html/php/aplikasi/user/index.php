...
<body>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?= $no++; ?></td>
                                    <td><img src="../assets/img/<?= $dUser['foto_user'] ?>"class="rounded-circle img-thumbnail" style="<width:70px></width:70px"></td>
                                    <td><?= $dUser['nm_user']; ?></td>
    ...
    <script> "https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-C6RzsynM9kWDrMNeT87bh95OGNyZPhcTNXj1NW7RuBCsyN/o0jlpcV8Qyq46cDfL" crossorigin="anonymous"></script>
</body>
</html>